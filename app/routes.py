...
async def home(request: Request):
    """
    Обрабатывает GET-запрос на главную страницу приложения.

    Аргументы:
        request (Request): объект запроса FastAPI.

    Возвращает:
        TemplateResponse: отрендеренный шаблон base.html.
    """
...
async def timetable(request: Request):
    """
    Обрабатывает GET-запрос на страницу расписания.

    Аргументы:
        request (Request): объект запроса FastAPI.

    Возвращает:
        TemplateResponse: отрендеренный шаблон timetable.html.
    """
...
async def rating(request: Request):
    """
    Обрабатывает GET-запрос на страницу рейтингов.

    Аргументы:
        request (Request): объект запроса FastAPI.

    Возвращает:
        TemplateResponse: отрендеренный шаблон rating.html.
    """
